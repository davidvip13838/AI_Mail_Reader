#!/bin/bash
# Script to set environment variables and deploy after environment is ready
...
if [ $? -eq 0 ]; then
  ...
  echo "Failed to set environment variables. Make sure environment is in 'Ready' state."
